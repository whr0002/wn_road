...
public class MapService {
    ...
    public static NavigationDataSet calculateRoute(String startCoords, String targetCoords, int mode) {
        ...
        Log.i("debug", "urlPedestrianMode: " + urlPedestrianMode);
        ...
        Log.i("debug", "urlCarMode: " + urlCarMode);
    ...
    public static NavigationDataSet getNavigationDataSet(byte[] response){
        NavigationDataSet navigationDataSet = null;
